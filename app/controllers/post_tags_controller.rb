class PostTagsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @post_tag.save
        format.html { redirect_to post_tag_url(@post_tag), notice: "Post tag was successfully created." }
  ...
  def update
    respond_to do |format|
      if @post_tag.update(post_tag_params)
        format.html { redirect_to post_tag_url(@post_tag), notice: "Post tag was successfully updated." }
